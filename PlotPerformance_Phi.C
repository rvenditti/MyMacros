...
void PlotPerformance_Phi(){
  ...
  gStyle->SetOptStat(0000000);	
   ...
   std::vector<TString> NumIsoNamesLooseFakeTau;
	...
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterLooseIso3H");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterLooseIso3HRho");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterChIsoPtSum");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso_05");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso_1");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso_15");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso_Rho_Off");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterNewIso_RhoNe_Off");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchPhi_AfterIsoPU");
	...
	f1->cd();
	histoDenLoose[i] = (TH1F*)hTauGenMatchPhi->Clone();
	...
	hFakeRateLoose[0]->GetXaxis()->SetTitle("gen. #phi_{#tau}");
	...
	legend->Draw("same");
	FakeRateCanvas->SaveAs("./PU40/EffPhi.pdf"); 
