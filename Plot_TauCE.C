...
TFile *f1 = TFile::Open("histo_file_HToTauTau_13TeV_Fall13dr_PU20bx25.root");
  ...
  TH1F* hTau_chargedIsoPtSum_PU20 = (TH1F*)f1->Get("hTau_chargedIsoPtSum_CE");
  TH1F* hTau_neutralIsoPtSum_PU20 = (TH1F*)f1->Get("hTau_neutralIsoPtSum_CE");
  TH1F* hTau_puCorrPtSum_PU20 = (TH1F*)f1->Get("hTau_puCorrPtSum_CE");
  TH1F* hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_PU20 = (TH1F*)f1->Get("hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_CE");
  TH1F* hTau_NewRawIsoCE_PU20 = (TH1F*)f1->Get("hTau_NewRawIsoCE");		

  TH1F* hTau_chargedIsoPtSum_PU40 = (TH1F*)f2->Get("hTau_chargedIsoPtSum_CE");
  TH1F* hTau_neutralIsoPtSum_PU40 = (TH1F*)f2->Get("hTau_neutralIsoPtSum_CE");
  TH1F* hTau_puCorrPtSum_PU40 = (TH1F*)f2->Get("hTau_puCorrPtSum_CE");
  TH1F* hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_PU40 = (TH1F*)f2->Get("hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_CE");
 TH1F* hTau_NewRawIsoCE_PU40 = (TH1F*)f2->Get("hTau_NewRawIsoCE");		

  TH1F* hTau_chargedIsoPtSum_8TeV = (TH1F*)f3->Get("hTau_chargedIsoPtSum_CE");
  TH1F* hTau_neutralIsoPtSum_8TeV = (TH1F*)f3->Get("hTau_neutralIsoPtSum_CE");
  TH1F* hTau_puCorrPtSum_8TeV = (TH1F*)f3->Get("hTau_puCorrPtSum_CE");
  TH1F* hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_8TeV = (TH1F*)f3->Get("hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_CE");
...
gPad->SetLogy();
  ...
  hTau_CombinedIsolationDeltaBetaCorrRaw3Hits_8TeV->SetLineColor(kMagenta);
	...
	hTau_NewRawIsoCE_PU20->SetMarkerColor(kBlue);
	hTau_NewRawIsoCE_PU40->SetMarkerColor(kTeal);
 ...
 IsolationVar->SaveAs("IsolationVarCE.pdf");
	...
	TH2F* hTau_NVtxVSpuCorrPtSum_PU20 = (TH2F*)f1->Get("hTau_NVtxVSpuCorrPtSum_CE");
	TH2F* hTau_NVtxVSpuCorrPtSum_PU40 = (TH2F*)f2->Get("hTau_NVtxVSpuCorrPtSum_CE");
	TH2F* hTau_NVtxVSpuCorrPtSum_8TeV = (TH2F*)f3->Get("hTau_NVtxVSpuCorrPtSum_CE");
	
	TH2F*   hTau_NVtxVSChIso_PU20 = (TH2F*)f1->Get("hTau_NVtxVSChIso_CE");
	TH2F*   hTau_NVtxVSChIso_PU40 = (TH2F*)f2->Get("hTau_NVtxVSChIso_CE");
	TH2F*   hTau_NVtxVSChIso_8TeV = (TH2F*)f3->Get("hTau_NVtxVSChIso_CE");
	
	
	TH2F*    hTau_NVtxVSNeIso_PU20 = (TH2F*)f1->Get("hTau_NVtxVSNeIso_CE");
	TH2F*    hTau_NVtxVSNeIso_PU40 = (TH2F*)f2->Get("hTau_NVtxVSNeIso_CE");
	TH2F*    hTau_NVtxVSNeIso_8TeV = (TH2F*)f3->Get("hTau_NVtxVSNeIso_CE");
	
	TH2F*    hTau_NVtxVSRawIso_PU20 = (TH2F*)f1->Get("hTau_NVtxVSRawIso_CE");
	TH2F*    hTau_NVtxVSRawIso_PU40 = (TH2F*)f2->Get("hTau_NVtxVSRawIso_CE");
	TH2F*    hTau_NVtxVSRawIso_8TeV = (TH2F*)f3->Get("hTau_NVtxVSRawIso_CE");
	
	TH2F*    hTau_NVtxVSNewRawIso_PU20 = (TH2F*)f1->Get("hTau_NVtxVSNewRawIso_CE");
	TH2F*    hTau_NVtxVSNewRawIso_PU40 = (TH2F*)f2->Get("hTau_NVtxVSNewRawIso_CE");
	TH2F*    hTau_NVtxVSNewRawIso_8TeV = (TH2F*)f3->Get("hTau_NVtxVSNewRawIso_CE");
	...
	TF1  *fun8TEV = new TF1("fun8TEV"," [0]*x + [1]",0,60) ; 
	
	for(int i=0;i<70; i++){
		hTau_NVtxVSpuCorrPtSum_PU20->GetBinContent(i);
	}
	
	cout<<" ************************************************************ fit PUCorr pu40  ************************************************************"<<endl;
	prof2->Fit("funPU40","N0");
	cout<<"  pu corr chi2= "<<funPU40->GetChisquare()<<endl;	
	cout<<" ************************************************************ fit PUCorr pu20  ************************************************************"<<endl;
	prof1->Fit("funPU20","N0");
	cout<<"  pu corr chi2= "<<funPU20->GetChisquare()<<endl;
	cout<<" ************************************************************ fit PUCorr 8tev  ************************************************************"<<endl;
	prof3->Fit("fun8TEV","N0"); 
    cout<<"  pu corr chi2= "<<fun8TEV->GetChisquare()<<endl;
	...
	prof_newiso40->Draw("SAME");
	prof_iso40->SetMinimum(0);
	IsolationComparison->SaveAs("RawIsolation_CentralEta.pdf");
	////////////////////NEW ISO/////////////////////////////////////////////	
	...
	TH2F*    hTau_NeIsoVSpuCorrIso_PU20 = (TH2F*)f1->Get("hTau_NeIsoVSpuCorrIso_CE");
	TH2F*    hTau_NeIsoVSpuCorrIso_PU40 = (TH2F*)f2->Get("hTau_NeIsoVSpuCorrIso_CE");
	TH2F*    hTau_NeIsoVSpuCorrIso_8TeV = (TH2F*)f3->Get("hTau_NeIsoVSpuCorrIso_CE");
	CorrelationPU->cd(1);
