...
void PlotPerformance_Eta(){
  ...
  gStyle->SetOptStat(0000000);	
   ...
   std::vector<TString> NumIsoNamesLooseFakeTau;
	...
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterLooseIso3H");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterLooseIso3HRho");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterChIsoPtSum");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso_05");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso_1");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso_15");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso_Rho_Off");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterNewIso_RhoNe_Off");
	NumIsoNamesLooseFakeTau.push_back("hTauGenMatchEta_AfterIsoPU");
	...
	f1->cd();
	histoDenLoose[i] = (TH1F*)hTauGenMatchEta->Clone();
	...
	hFakeRateLoose[0]->GetXaxis()->SetTitle("gen. #Eta_{#tau}");
	hFakeRateLoose[0]->GetYaxis()->SetTitle("Efficiency");

	FakeRateCanvas->cd();
	TLegend* legend = new TLegend( 0.2, 0.18, 0.55, 0.45);
	...
	legend->AddEntry(hFakeRateLoose[9], "Charged Particle |dz|>2mm Correction (2*RMS)", "p");
	legend->AddEntry(hFakeRateLoose[3], "Charged Particle Isolation", "p");
	legend->Draw("same");
	FakeRateCanvas->SaveAs("./PU40/EffEta.pdf"); 
